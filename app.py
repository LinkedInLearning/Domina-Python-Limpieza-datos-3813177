...
datos = {
    ...
    "metros": [None, None, 500, None, None, None, 400, None, None, None, 250, None],
    ...
    "comodidades": [None, "Balcón", None, None, None, None, None, None, "Terraza", None, "Patio", None],
...
df = df.dropna(axis=1, thresh=len(df) - 8)
