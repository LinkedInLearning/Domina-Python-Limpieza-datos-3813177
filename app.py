...
datos = {
    ...
    "num_cuartos": [3, 2, 4, 1, 3, 3, 4, 2, 1, 3, 4, 2],
    "tipo_prop": ["Casa", "Apartamento", None, "Apartamento", "Casa", None, "Casa", None, None, "Apartamento", "Casa", "Apartamento"],
...
valor_mas_frecuente = df['tipo_prop'].mode()[0]

print("El valor más frecuente es: ", valor_mas_frecuente)

df['tipo_prop'].fillna(valor_mas_frecuente, inplace=True)
