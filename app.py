...
datos = {
    ...
    "fecha_publicacion": ['2023-08-26', '2028-11-10', '1988-11-08', '2023-11-01', '2024-08-05', '2058-11-07', '1998-09-24', '2022-11-03', '2028-11-11', '2022-05-24', '2023-08-10', '2023-06-07'] 
}
...
df = df[
        (df["fecha_publicacion"] >= pd.Timestamp("2022-01-01")) & 
        (df["fecha_publicacion"] <=  pd.Timestamp("2024-04-15"))
    ]
